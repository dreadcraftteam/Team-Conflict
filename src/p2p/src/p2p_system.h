...
public:
    ...
    CON_COMMAND_MEMBER_F(CCoplaySystem, "p2p_connect", CoplayConnect, "Connect to a Coplay game", FCVAR_NONE);
...
private:
	...
	CON_COMMAND_MEMBER_F(CCoplaySystem, "p2p_about", PrintAbout, "", FCVAR_NONE);
    ...
    CON_COMMAND_MEMBER_F(CCoplaySystem, "p2p_connect_lobby", ConnectToLobby, "", FCVAR_HIDDEN);
#endif
